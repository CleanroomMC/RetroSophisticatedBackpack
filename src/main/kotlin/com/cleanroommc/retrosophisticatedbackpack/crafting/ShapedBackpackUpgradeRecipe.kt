package com.cleanroommc.retrosophisticatedbackpack.crafting
...
class ShapedBackpackUpgradeRecipe(
    ...
    override fun getCraftingResult(inventory: InventoryCrafting): ItemStack {
        ...
        if (!outputStack.isEmpty) {
            ...
            val backpackWrapper =
                backpackStack.getCapability(CapabilityHandler.BACKPACK_ITEM_HANDLER_CAPABILITY!!, null)!!
            val newBackpackWrapper =
                outputStack.getCapability(CapabilityHandler.BACKPACK_ITEM_HANDLER_CAPABILITY, null)!!
